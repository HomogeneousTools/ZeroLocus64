...
const EXAMPLES = [
  ...
  { label: "11.10", caption: "split bundle on P^1 x P^1" },
  ...
  { label: "111.24", caption: "sparse small-value rows" },
  { label: "1120.WT", caption: "v3.1 equal-factor block" },
  { label: "142h1.wZ444", caption: "Fano 4-fold corpus example" },
  { label: "415GG2.A7522", caption: "Fano 4-fold corpus example" },
  { label: "3242H0.9962", caption: "Fano 4-fold corpus example" },
